...
class UserQueriesService {
  ...
  Future<MyProfileModel?> getMyProfile() async {
    ...
    String backupKey = "my-profile-sess";
    DateTime? lastHit;
      ...
      if (connectivityResult == ConnectivityResult.none) {
        if (prefs.containsKey(backupKey)) {
          ...
          if (data != null) {
            ...
            return queriesMyProfileModelFromJson(data);
          } else {
            return null;
          }
        } else {
        ...
        final response = await client.get(Uri.parse("$emuUrl/api/v1/user/my"),
            headers: header);
        if (response.statusCode == 200) {
          ...
          return queriesMyProfileModelFromJson(response.body);
